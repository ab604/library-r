...
At the time of writing I'm still a novice in using them, but I highly recommend Ethan Mollick's work as a good place to start. He's written posts on [writing prompts](https://www.oneusefulthing.org/p/working-with-ai-two-paths-to-prompting) and has resources such as the [prompt library](https://www.moreusefulthings.com/prompts).
