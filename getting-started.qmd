...
One of the most useful and important parts of any data analysis is plotting data and @sec-visualisation goes into detail. But to give you an example, we'll use the `ggplot2` package as an introduction to automating a task in code, and as a tool for understanding data.
