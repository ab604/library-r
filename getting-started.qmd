...
The introduction of [GPT-4](https://openai.com/research/gpt-4) and other powerful large language models such as [Claude 3](https://www.anthropic.com/) and [Gemini 1.5](https://deepmind.google/technologies/gemini/#introduction) since 2023 has meant that these tools are now some of the best ways to get help. with coding At the time of writing I'm still a novice in using them, but I highly recommend Ethan Mollick's work as a good place to start. He's written posts on [writing prompts](https://www.oneusefulthing.org/p/working-with-ai-two-paths-to-prompting) and has resources such as the [prompt library](https://www.moreusefulthings.com/prompts).
...
1.  First I told Claude who I wanted it to be: Belle, an R programmer who uses the tidyverse.
...
Belle gave me a very good answer, but used the pipe operator `%>%` from `magrittr` rather than the native R pipe `|>` (@sec-the-pipe). So I asked Belle to change it.
