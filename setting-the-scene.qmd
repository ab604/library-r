...
Our focus will be on importing, tidying and transforming data, but you may wish to explore the visualisation and modeling parts of the cycle yourself. For example, check out the [visualisation chapter of R4DS](https://r4ds.hadley.nz/data-visualize) and [Tidy Modeling with R](https://www.tmwr.org/).
