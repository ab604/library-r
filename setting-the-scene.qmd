...
You can skip this chapter if you want to dive straight into learning R. This chapter is primarily background and philosophy to set the scene before we start installing and using R.
:::
